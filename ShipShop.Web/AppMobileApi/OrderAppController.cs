...
{
    [RoutePrefix("api/app/order")]
    [Authorize]
    public class OrderAppController : ApiControllerBase
    {
        ...
        public OrderAppController(ApplicationUserManager userManager, IOrderService orderService, IOrderDetailService orderDetailService, IRegionService regionService, IErrorService errorService)
            : base(errorService)
        {
