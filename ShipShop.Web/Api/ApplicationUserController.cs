    ...
    public class ApplicationUserController : ApiControllerBase
    {
        ...
        public HttpResponseMessage GetListPaging(HttpRequestMessage request, int page, int pageSize, string filter = null)
        {
            return CreateHttpResponse(request, () =>
            {
                ...
                int totalRow = 0;
                var model = _userManager.Users.Include("Region");
        ...
        public async Task<HttpResponseMessage> ResetPass(HttpRequestMessage request, ChangePassViewModel changePassVM)
        {
            ...
            string userId = changePassVM.Id;//"<YourLogicAssignsRequestedUserId>";
            string newPassword = changePassVM.NewPassword; //"<PasswordAsTypedByUser>";
