...
namespace ShipShop.Web.Api
{
    ...
    public class RegionController : ApiControllerBase
    {
        ...
        [Route("getall")]
        [HttpGet]
        [Authorize(Roles = Common.RolesConstants.ROLES_GET_LIST_REGION + "," + Common.RolesConstants.ROLES_FULL_CONTROL)]
        ...
        [Route("create")]
        [HttpPost]
        [Authorize(Roles = Common.RolesConstants.ROLES_ADD_REGION + "," + Common.RolesConstants.ROLES_FULL_CONTROL)]
        ...
        [Route("getbyid")]
        [HttpGet]
        [Authorize(Roles = Common.RolesConstants.ROLES_EDIT_REGION + "," + Common.RolesConstants.ROLES_FULL_CONTROL)]
        ...
        [Route("Delete")]
        [HttpDelete]
        [Authorize(Roles = Common.RolesConstants.ROLES_DELETE_REGION + "," + Common.RolesConstants.ROLES_FULL_CONTROL)]
