...
namespace ShipShop.Web.Api
{
    ...
    public class AreaController : ApiControllerBase
    {
        ...
        [Route("getall")]
        [HttpGet]
        [Authorize(Roles = Common.RolesConstants.ROLES_GET_LIST_AREA + "," + Common.RolesConstants.ROLES_FULL_CONTROL)]
        ...
        [Route("create")]
        [HttpPost]
        [Authorize(Roles = Common.RolesConstants.ROLES_ADD_AREA + "," + Common.RolesConstants.ROLES_FULL_CONTROL)]
        ...
        [Route("getbyid")]
        [HttpGet]
        [Authorize(Roles = Common.RolesConstants.ROLES_EDIT_AREA + "," + Common.RolesConstants.ROLES_FULL_CONTROL)]
        ...
        [Route("Delete")]
        [HttpDelete]
        [Authorize(Roles = Common.RolesConstants.ROLES_DELETE_AREA + "," + Common.RolesConstants.ROLES_FULL_CONTROL)]
